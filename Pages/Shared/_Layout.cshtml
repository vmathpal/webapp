...
<body>
    <header>
        <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-light bg-white border-danger box-shadow mb-3">
            <div class="container">
                <a class="navbar-brand" asp-area="" asp-page="/Index"><img width="100" src="~/images/logo.jpg"/></a>
                <a class="navbar-brand" asp-area="" asp-page="/Index">Home</a>
                <a class="navbar-brand" asp-area="" asp-page="/Weather">Weather</a>
